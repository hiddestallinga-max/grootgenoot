...
export default function StickyCTA() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-30 border-t border-ink/10 bg-white/95 backdrop-blur-md lg:hidden">
      <div className="mx-auto flex max-w-5xl items-center gap-3 px-4 py-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))]">
        <a
          href="tel:+31612154010"
          className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-support px-4 py-3 text-lg font-bold text-support transition active:scale-95"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
        ...
        <Link
          ...
          className="flex flex-[1.5] items-center justify-center rounded-xl bg-support px-4 py-3 text-lg font-bold text-white transition active:scale-95"
        >
          Gratis kennismaken
        </Link>
      </div>
